    ...
    const plans = [
        {
            ...
            limit: 3,
            price: '$0/mo',
            features: ['Up to 3 Documents', 'Basic Support', 'Standard Processing'],
        ...
        },
        {
            ...
            limit: 10,
            price: '$29/mo',
            features: ['Up to 10 Documents', 'Priority Support', 'Failed Indexing Retry'],
        ...
        },
        {
            ...
            limit: 30,
            price: 'Contact Us',
            features: ['Up to 30 Documents', 'Dedicated Account Manager', 'SLA', 'Custom Integrations'],
            btnText: 'Contact Sales',
            btnClass: 'btn-dark',
            disabled: false
        }

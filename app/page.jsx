    ...
    return (
        <>
            ...
            <div className="container py-5">
                ...
                {/* HERO SECTION */}
                {!me ? (
                    <div className="hero-section text-center fade-in">
                        <h1 className="hero-title display-4 fw-bold mb-4">Your Enterprise Knowledge,<br />Instantly Accessible.</h1>
                        ...
                        <div className="d-flex gap-3 justify-content-center">
                            ...
                            <a href="https://pleach.in" target="_blank" className="btn btn-outline-secondary btn-lg">
                                Learn More
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="row mb-5">
                            <div className="col-md-4 mb-4">
                                <div className="card h-100 p-4 shadow-sm border-0">
                                    <div className="stat-value display-4 fw-bold text-primary">{me.doc_count || 0}</div>
                                    <div className="stat-label text-muted">Documents Indexed</div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-4">
                                <div className="card h-100 p-4 shadow-sm border-0">
                                    <div className="stat-value display-4 fw-bold text-primary">{me.max_docs || 10}</div>
                                    <div className="stat-label text-muted">Document Limit</div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-4">
                                <div className="card h-100 p-4 shadow-sm border-0">
                                    <div className="stat-value display-4 fw-bold text-primary">{me.plan ? me.plan.toUpperCase() : "FREE"}</div>
                ...
                {/* SERVICES GRID */}
                <h2 className="section-title fw-bold mb-4">Comprehensive Services</h2>
